...
export class HttpClient {
  ...
  async post<T>(endpoint: string, body?: unknown, options: Partial<RequestOptions> = {}): Promise<ApiResponse<T>> {
    return this.request<T>(endpoint, { ...options, method: 'POST', body });
  }

  async put<T>(endpoint: string, body?: unknown, options: Partial<RequestOptions> = {}): Promise<ApiResponse<T>> {
  ...
  async patch<T>(endpoint: string, body?: unknown, options: Partial<RequestOptions> = {}): Promise<ApiResponse<T>> {
